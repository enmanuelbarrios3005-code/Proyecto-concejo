<div class="card card-primary card-outline p-2">
    <div class="card-header">
        <h3 class="card-title">Gacetas</h3>
    </div>
    <div class="card-body">
            ...
            <tbody>
                @foreach($gasetas as $gaseta)
                    <tr>
                        ...
                        <td>{{ $gaseta->fecha_aprobacion }}</td>
                        <td>{{ $gaseta->categoria }}</td>
                        
                        <td>
                            <a href="{{ Storage::url('/' . $gaseta->ruta) }}" class="btn btn-success btn-sm" target="_blank">
                                <i class="fas fa-eye"></i> 
                            </a>
                        </td>
                        <td>
                            <button type="button" class="btn btn-info btn-sm" onclick="printPDF('{{ Storage::url('/' . $gaseta->ruta) }}')">
