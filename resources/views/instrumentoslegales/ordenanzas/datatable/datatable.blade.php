            ...
            <tbody>
                @foreach($ordenanzas as $ordenanza)
                    <tr>
                        ...
                        <td>
                            <a href="{{ Storage::url($ordenanza->ruta) }}" class="btn btn-success btn-sm" target="_blank">
                        ...
                        <td>
                            <button type="button" class="btn btn-info btn-sm" onclick="printPDF('{{ Storage::url('/' . $ordenanza->ruta) }}')">
                                <i class="fas fa-print"></i> 
                            </button>
                        </td>
                      
                        <td>
                            <a href="{{ route('ordenanzas.download', $ordenanza->nombre) }}" class="btn btn-warning btn-sm">
