...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><i class="fa-solid fa-chart-column"></i> Charjs</h3>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var conteoMensual = {!! $conteoMensual !!};
        ...
        function generateChart(year) {
            ...
            for (let i = 0; i < 12; i++) {
                ...
                barChartData.labels.push(monthLabel + (year ? ' ' + year : ''));
            }
            ...
            var barChartOptions = {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: year ? 'AÑO DE APROBACIÓN: ' + year : 'AÑO DE APROBACIÓN:',
                        font: {
                            size: 18
                        },
                        position: 'bottom'
        ...
        document.getElementById('generateChart').addEventListener('click', function() {
            ...
            if (year && year.length === 10) {
                ...
                fetch(`/getConteoMensual?year=${year}`)
        ...
        document.getElementById('estadisticaModal').addEventListener('shown.bs.modal', function() {
            ...
            let formattedYear = `${year}-01-01`;
            document.getElementById('yearInput').value = formattedYear;
        });
