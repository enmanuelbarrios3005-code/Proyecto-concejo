...
<div class="d-flex justify-content-end mb-3">
    ...
    <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
        <i class="fas fa-upload"></i> Importar Acuerdos
    </button>
  
    @include('instrumentoslegales.acuerdos.modal.modal')

    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#estadisticaModal" data-bs-whatever="estadistica">
        <i class="fa-solid fa-chart-line"></i>  Estadísticas
    </button>
    
    @include('instrumentoslegales.acuerdos.modal.modal_estadistica')

</div>
@include('instrumentoslegales.acuerdos.datatable.datatable')
<script>
    $('#example').DataTable({
        "language": {
