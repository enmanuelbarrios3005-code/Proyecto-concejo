...
<div class="d-flex justify-content-end mb-3">
    ...
    <button type="button" class="btn btn-primary btn-md me-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
        <i class="fas fa-upload"></i> Importar Resoluciones
    </button>
  
    @include('instrumentoslegales.resoluciones.modal.modal')

    <button type="button" class="btn btn-success btn-md" data-bs-toggle="modal" data-bs-target="#estadisticaModal" data-bs-whatever="estadistica">
        <i class="fa-solid fa-chart-line"></i>  Estadísticas
    </button>
    
    @include('instrumentoslegales.resoluciones.modal.modal_estadistica')
...
<script>
    document.getElementById('uploadForm').addEventListener('submit', function(event) {
        const fileInput = document.getElementById('resolucion');
