        ...
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="estadisticaModalLabel">
                    <i class="fa-solid fa-chart-pie"></i> Estadísticas de Resoluciones
                </h1>
            ...
            <div class="modal-body">
                ...
                <section class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                @include('instrumentoslegales.resoluciones.estadisticas.Bar_Chart')
            ...
            <div class="modal-footer">
                ...
                <div class="form-group">
                    ...
                    <label for="fecha_aprobaciono">Seleccione la fecha que desea buscar:</label>
