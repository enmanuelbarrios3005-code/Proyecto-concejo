...
@extends('layouts.app')
@section('title', 'Cargar Extraordinaria')
@section('container')
    <!-- ./datatable -->
    ...
    <div class="d-flex justify-content-end mb-3">
        ...
        Importar Extraordinaria
        </button>   
    </div>
    @include('actas.extraordinarias.modal.modal') <!-- Cambiado a extraordinaria -->
    @include('actas.extraordinarias.datatable.datatable') <!-- Cambiado a extraordinaria -->
    <!-- script ----------------------------- -->
    <script>
        $('#example').DataTable({
            "language": {
    ...
    <script>
        document.getElementById('uploadForm').addEventListener('submit', function(event) {
            const fileInput = document.getElementById('extraordinaria'); // Cambiado a extraordinaria
    ...
    <script>
        function printTable() {
            ...
            win.document.write('<html><head><title>Imprimir Extraordinaria</title>');
