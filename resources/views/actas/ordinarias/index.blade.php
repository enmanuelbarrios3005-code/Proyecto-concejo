@extends('layouts.app')
@section('title', 'Cargar Ordinaria')
@section('container')
    <!-- ./datatable -->
    ...
    @include('actas.ordinarias.modal.modal') <!-- Cambiado a ordinaria -->
    @include('actas.ordinarias.datatable.datatable') <!-- Cambiado a ordinaria -->
    <!-- script ----------------------------- -->
    <script>
        $('#example').DataTable({
            "language": {
    ...
    <script>
        document.getElementById('uploadForm').addEventListener('submit', function(event) {
            const fileInput = document.getElementById('ordinaria'); // Cambiado a ordinaria
    ...
    <script>
        function printTable() {
            ...
            win.document.write('<html><head><title>Imprimir Ordinaria</title>');
