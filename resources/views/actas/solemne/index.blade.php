...
@section('container')
    ...
    @include('actas.solemne.modal.modal') <!-- Cambiado a solemne -->
    @include('actas.solemne.datatable.datatable') <!-- Cambiado a solemne -->
    <!-- script ----------------------------- -->
    <script>
        $('#example').DataTable({
            "language": {
    ...
    <script>
        document.getElementById('uploadForm').addEventListener('submit', function(event) {
            const fileInput = document.getElementById('solemne'); // Cambiado a solemne
    ...
    <script>
        function printTable() {
            ...
            win.document.write('<html><head><title>Imprimir Solemne</title>');
