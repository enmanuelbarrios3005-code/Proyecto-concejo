    ...
    <section class="intro-section py-3 animate__animated"></section>
        ...
        <form action="{{ route('legales.search') }}" method="GET" class="mb-4">     
</form>
        @include('web.ordenanzas.datatable.tablet')
            </div>                  
        
            @include('web.ordenanzas.modal.modal')              
        ...
        <section class="intro-section py-3 animate__animated"></section>         
             ...
             @include('web.ordenanzas.view.footer')
        <section class="intro-section py-3 animate__animated"></section>            
