    ...
    <section class="intro-section py-3 animate__animated"></section>
        ...
        <form action="{{ route('cetas.search') }}" method="GET" class="mb-4">
        
</form>  
        <!-- Tu tabla de ordenanzas aquí -->
        @include('web.gacetas.datatable.tablet')
            </div>                  
        
            @include('web.gacetas.modal.modal')              
        ...
        <section class="intro-section py-3 animate__animated"></section>         
             ...
             @include('web.gacetas.view.footer')
        <section class="intro-section py-3 animate__animated"></section>            
