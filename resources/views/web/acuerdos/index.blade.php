    ...
    <section class="intro-section py-3 animate__animated"></section>
        ...
        <div class="container mt-5">
            ...
            <form action="{{ route('acues.search') }}" method="GET" class="mb-4">
        
            @include('web.acuerdos.datatable.tablet')
        
        </div>
            @include('web.acuerdos.modal.modal')              
        ...
        <section class="intro-section py-3 animate__animated"></section>         
             ...
             @include('web.acuerdos.view.footer')
        <section class="intro-section py-3 animate__animated"></section>            
